...
var myQuestions = [
    ...
    },
    {
        ...
        potentialAnswers: ['The <head> section', 'The <body> section', 'The <footer> section', 'Both 1 and 2'],
        correctAnswer: 'Both 1 and 2'
    },
    {
        question: 'How do you write "Hello World" in an alert box?',
        potentialAnswers: ['alert("Hello World);', 'alertBox("Hello World);', 'window("Hello World);', 'msgBox("Hello World);'],
